...
class Module extends \yii\base\Module
{
    ...
    public function init()
    {
        ...
        Yii::$app->i18n->translations['role'] = [
            'class' => 'yii\i18n\PhpMessageSource',
            'basePath' => __DIR__ . '/messages',
            //'forceTranslation' => true,
        ];

        Yii::$app->i18n->translations['department'] = [
            'class' => 'yii\i18n\PhpMessageSource',
            'basePath' => __DIR__ . '/messages',
            //'forceTranslation' => true,
        ];
    ...
    protected function getDefaultModelClasses()
    {
        ...
        return [
            ...
            'Department' => 'app\modules\user\models\Department',
            ...
            'RoleSearch' => 'app\modules\user\models\search\RoleSearch',
            'DepartmentSearch' => 'app\modules\user\models\search\DepartmentSearch',
    ...
    {
        // check valid routes
        $validRoutes  = [$this->defaultRoute, "admin", "copy", "auth", "role", "department"];
        $isValidRoute = false;
