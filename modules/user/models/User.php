...
//                'message' => Yii::t('user', '{attribute} can contain only letters, numbers, and "_"')],
            ...
            ['pa_for', 'required', 'when' => function ($attributes) {
                return $attributes->role_id == 3;
    ...
    {
        $department = $this->module->model("Department");
    ...
    /**
     * Get total record of users by attribute
     * @param String $attribute, attribute name in database
     * @param String $value, value to find
     * @return Integer Total of records
     */
    public static function getCountByAttribute($attribute, $value){
        return self::find()->where([$attribute, $value])->count();
    }
}